...
window.onload = function() {
    ...
    idpopup_img_box.style.height = '100vh'
...
function img_box(self) {
    ...
    img_img_box.onload = function() {
        ...
        idpopup_img_box.innerHTML = '<img style="height:100%; width:auto;" src=' + namepic_img_box + '>'
		
		w = idpopup_img_box.width;
		h = idpopup_img_box.height;
